...
/*Cách dùng stdout để ghi vào file  :
      ---  Truyền vào  hàm  FILE *f=stdout  ---
   ---  Không cần  câu lệnh if kiểm tra mở file ---
   ---Không được đóng file  trong  hàm  mà  ta cần thực hiện đóng file vừa  mở  trong  hàm chính ---
*/
#include<bits/stdc++.h>
#include<stdlib.h>
#include<string.h>
...
//  sua  lai cac  ham nay de  co the in ra ket qua  vao  
...
int  main(){
	...
	FILE *f=fopen("Bai2-3_ketqua.txt","w");
	DocFile (&s,n,tentep);
